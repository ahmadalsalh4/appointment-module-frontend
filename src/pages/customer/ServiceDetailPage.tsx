      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 sticky top-8">
            {service.category && (
              <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-indigo-50 text-indigo-700 uppercase tracking-wide mb-6">
            ...
            <div className="flex items-center text-gray-700 bg-gray-50 rounded-lg p-4 mb-6">
              <svg
            ...
            {!token ? (
              ...
              <>
                ...
                <button
                  ...
                  className="w-full md:w-auto px-8 py-3 bg-indigo-600 text-white font-semibold rounded-lg shadow-md hover:bg-indigo-700 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {checkAvailability.isPending ? (
                ...
                {slots.length > 0 && (
                  <div className="mt-8 pt-8 border-t border-gray-100">
                    ...
                    {/* Final Book Button */}
                    {selectedTime && (
                      <div className="mt-8 p-4 bg-green-50 border border-green-200 rounded-lg flex flex-col sm:flex-row items-center justify-between gap-4">
                        <div>
                ...
                {slots.length === 0 && checkAvailability.data && (
                  <div className="mt-8 text-center text-gray-500 bg-gray-50 p-6 rounded-lg">
